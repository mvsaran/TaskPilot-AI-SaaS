...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Server-Sent Events (SSE) stream for real-time task and sprint updates' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get unread real-time notifications (polling fallback)' }),
    openapi.ApiResponse({ status: 200, type: [Object] }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, swagger_1.ApiOperation)({ summary: 'Emit real-time workspace broadcast notification' }),
...
exports.NotificationsController = NotificationsController = __decorate([
    (0, swagger_1.ApiTags)('Notifications & Live Stream'),
